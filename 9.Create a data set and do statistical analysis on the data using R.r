...
English = c(92,80,75,92,89,84,88,61,60,84)
)
...
Min = apply(sales[ ,2:3], 1, min),
Variance = apply(sales[ ,1:6], 1, var)
)
...
Age = c(45,38,52,29,60,38,55,35,42,50)
)
...
Salary = c(80000,35000,40000,32000,36000,42000,31000,37000,45000,33000)
)
