...
R prpogram:
emails <- c("arul@gmail.com", "sneha@yahoo.com", "rahul@outlook.com")
...
R program:
input <- c(" R Programming ", " Data Science ", " IIT ")
...
R program:
product_codes <- c("PRD9002", "PRD8701", "ABC9802")
...
word_count <- length(strsplit(sentence, " ")[[2]])
word_count
...
R program:
names <- c("Goutham", "Karthikaya", "Sneha")
abbr <- substr(names, 1, 2)
abbr

5.10
Search Operation in Text
R program:
names <- c("Arun", "guna", "Ravi", "John")
...
R Program
products <- data.frame(
Product = c(" lenovo phone ", "SAMSUNG-TV ", " HP laptop"),
